...
Source0  : https://git.zx2c4.com/wireguard-tools/snapshot/wireguard-tools-1.0.20200827.tar.xz
...
%prep
%setup -q -n wireguard-tools-1.0.20200827
cd %{_builddir}/wireguard-tools-1.0.20200827
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612979513
...
cp %{_builddir}/wireguard-tools-1.0.20200827/COPYING %{buildroot}/usr/share/package-licenses/WireGuard/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd src
%make_install
popd
