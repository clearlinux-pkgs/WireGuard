...
Source0  : https://git.zx2c4.com/wireguard-tools/snapshot/wireguard-tools-1.0.20210424.tar.xz
...
%prep
%setup -q -n wireguard-tools-1.0.20210424
cd %{_builddir}/wireguard-tools-1.0.20210424
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619388118
...
cp %{_builddir}/wireguard-tools-1.0.20210424/COPYING %{buildroot}/usr/share/package-licenses/WireGuard/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd src
%make_install
popd
